...
int main()
{
    ...
    /// <param name="Cres">Reference to an array of types, unmodifiable</param>
    /// <param name="C">a different array of objects of type Car</param>
    /// <param name="8">number of elements in the array</param>
    /// <param name="Tesla">value to search for within array</param>
    ...
    /// <param name="All students:">title of the list to be printed</param>
    /// <param name="S">constant array of Student objects created above</param>
    /// <param name="6">number of elements in the array</param>
    ...
    /// <param name="Sres">Reference to an array of Students, unmodifiable</param>
    /// <param name="S">a different array of objects of type Student</param>
    /// <param name="6">number of elements in the array</param>
    /// <param name=4.0>value to search for within array</param>
    ...
    /// <param name="All employees:">title of the list to be printed</param>
    /// <param name="E">constant array of Student objects created above</param>
    /// <param name="6">number of elements in the array</param>
    ...
    /// <param name="Eres">Reference to an array of Students, unmodifiable</param>
    /// <param name="E">a different array of objects of type Employee</param>
    /// <param name="6">number of elements in the array</param>
    /// <param name=111>value to search for within array</param>
    ...
    /// <param name=555>searching for office number 555 this time instead of 111</param>
    ...
    // Title: "INTEGERS"
    /// <param name="INTEGERS">title of the list to be printed</param>
    /// <param name="a">constant array of integers</param>
    /// <param name="6">number of elements in the array</param>
